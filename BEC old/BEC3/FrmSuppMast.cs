...
namespace BEC3
{
    public partial class FrmSuppMast : Form
    {
        public FrmSuppMast()
        {
            InitializeComponent();
        ...
        private void FrmSuppMast_Load(object sender, EventArgs e)
        {
            ...
            BALSupp baobj = new BALSupp();
            DataTable da = new DataTable();
            da.Load(baobj.SuppSelect());
            if (da.Rows.Count != 0)
            {
        ...
        private void ListView1_ItemActivate(object sender, EventArgs e)
        {
            ...
            DataTable da = new DataTable();
            da.Load(baobj.SuppuniqSelect(beobj));
            if (da.Rows.Count != 0)
            {
        ...
        private void c1Button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable da = new DataTable();
            da.Load(baobj.SuppTypeSelect(beobj));
            ...
            if (da.Rows.Count > 0)
            {
                ...
                {
                    MessageBox.Show("Duplicate SupplierName!! Failed To Save");
                }
            }
            else
            {
                ...
                if (baobj.Suppinsert(beobj) == true)
                {
        ...
        Update:
            if (baobj.Suppupdate(beobj) == true)
            {
        ...
        private void c1Button2_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                if (baobj.SuppDelete(beobj) == true)
                {
