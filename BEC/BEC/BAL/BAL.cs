...
namespace BALayer
{
    ...
    public class BALPhyRep
    {
        BELPhyRep beobj = new BELPhyRep();
        DALPhyRep daobj = new DALPhyRep();
        public SqlDataReader PhyRep(BELPhyRep beobj)
        {
            return daobj.PhyReport(beobj);
        }
    }
}
